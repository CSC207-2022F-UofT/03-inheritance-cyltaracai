...
public abstract class Bag {
     ...
     */
    public void setColor(String new_col){
        this.color = new_col;
    }
    ...
    public void increaseCapacity(int n) {
        ...
        // update contents such that its capacity is increased by n
        String[] new_contents = Arrays.copyOf(this.contents, this.capacity);
